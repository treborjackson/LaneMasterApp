...
export const OIL_PATTERN_DETAILS: Record<string, OilPatternDetail> = {
  'House Shot': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — tension kills your release',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Sport Shot': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — composure on a sport shot is half the battle',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Cheetah': {
    name: 'Cheetah',
    ballRecommendations: ['Smooth urethane or symmetrical solid on the fresh — predictable motion', 'Low-hook pearl reactive on the burn — pushes reaction further downlane', 'Plastic/spare ball if the pattern is extremely short or fried'],
    ...
    proTips: [
      ...
      'Take a breath before every shot — a rushed release will over-rotate on this short pattern',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Chameleon': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — staying calm helps you notice subtle changes sooner',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Scorpion': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — a smooth, controlled release protects your angle',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Shark': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — Shark punishes tension-driven lofts and pulls',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Viper': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — controlled tempo prevents over-revving on short oil',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Christmas Tree': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — this pattern rewards consistent tempo',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'PBA Experience': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — PBA conditions are won or lost in the mental game',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
  ...
  'Badger': {
    ...
    proTips: [
      ...
      'Take a breath before every shot — patience is your biggest weapon on Badger',
      'Watch your ball go through the pins every shot to read how the pattern is transitioning',
    ],
